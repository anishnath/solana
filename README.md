...
[![Open in
Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/anishnath/solana-hello)
...
==============================================================================
pubkey: DHc4jNXbnMqs89BYZofr1DFjVDWvCVtmtcQJeiPdksvQ
==============================================================================
Save this seed phrase and your BIP39 passphrase to recover your new keypair:
century subway muffin notable live dial melt eyebrow system length chief gauge
==============================================================================
```
...
```bash
Hello to a Solana account...
Connection to cluster established: http://localhost:8899 { 'feature-set': 2045430982, 'solana-core': '1.7.8' }
Using account c821m6A92ujZsczpBGBn2AXLdh8mfGAejySTBWuVhdq containing 499999999.942978 SOL to pay for fees
Using program 59raNVAsFdKnZxUkyH7iJvHfJyPMTwWvswexXictpnna
Creating account 7hCbXrRxNoMHtfv2ur7aFHVhgNu9gheCrg6n7iTbb16M to say hello to
Saying hello to 7hCbXrRxNoMHtfv2ur7aFHVhgNu9gheCrg6n7iTbb16M
7hCbXrRxNoMHtfv2ur7aFHVhgNu9gheCrg6n7iTbb16M has been greeted 1 time(s)
Success
```
